// ==== mulaan kode konfigurasi ... ===

#pragma once

// ==== mulaan kode kredensial Jaringan & Semesta Maya ===
#define WIFI_SSID       "NAMA_WIFI_ANDA"
#define WIFI_PASS       "KATA_SANDI_WIFI_ANDA"

#define AIO_SERVER      "io.adafruit.com"
#define AIO_SERVERPORT  1883
#define AIO_USERNAME    "USERNAME_ADAFRUIT_IO_ANDA"
#define AIO_KEY         "AIO_KEY_ANDA"

#define BOT_TOKEN       "TOKEN_BOT_TELEGRAM_ANDA"
#define CHAT_ID         "CHAT_ID_ANDA"
// ==== akhiran kode ... ===

// ==== mulaan kode konfigurasi Perangkat Keras ===
const int RELAY_PIN = 23;
const int SOIL_PIN = 34;
// ==== akhiran kode ... ===

// ==== mulaan kode konfigurasi Ambang Batas & Waktu ===
...
// ==== mulaan kode Segel Kepercayaan (Sertifikat) ===
